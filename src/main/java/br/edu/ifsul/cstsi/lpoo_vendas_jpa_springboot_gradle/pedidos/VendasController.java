...
import br.edu.ifsul.cstsi.lpoo_vendas_jpa_springboot_gradle.clientes.ClienteService;
import br.edu.ifsul.cstsi.lpoo_vendas_jpa_springboot_gradle.itens.Item;
import br.edu.ifsul.cstsi.lpoo_vendas_jpa_springboot_gradle.itens.ItemService;
            ...
            if(cliente == null){
                ...
                if (itens.isEmpty()) {
                    ...
                    if(opcao == 1){
                        ...
                        System.out.println("Pedido salvo. " + pedidoSalvo + " Item adquiridos:" + itens);
                    }else if(opcao == 2){
